export const destinations = [
    ...
    "foodSpecialties": [
      {
        ...
        "desc": "Tangy coconut and raw mango kingfish curry served with hot local red unpolished rice."
      },
      {
        "name": "Pork Vindaloo",
        "desc": "Heritage Goan-Portuguese dish marinating pork in palm vinegar, garlic, and fiery Kashmiri chillies."
      },
      {
        "name": "Chicken Xacuti",
        "desc": "Rich chicken gravy prepared with complex roasted spices, white poppy seeds, and grated coconut."
      },
      {
        "name": "Bebinca",
        "desc": "Traditional 7-layer baked Goan dessert made from fresh coconut milk, ghee, sugar, and egg yolks."
      },
      {
        "name": "Prawn Balchão",
        "desc": "Fiery & tangy prawn pickle dish served with warm local Poi bread."
      },
      {
        "name": "Sanna & Sol Kadi",
        "desc": "Steamed rice cakes fermented with toddy paired with a digestive pink kokum-coconut drink."
      }
    ],
    ...
    "travelDestinationsInCity": [
      {
        ...
        "desc": "16th-century UNESCO World Heritage Baroque church holding St. Francis Xavier relics."
      },
      {
        "name": "Baga & Calangute Beaches",
        "desc": "Vibrant beach stretch famous for water sports, parasailing, and shacks."
      },
      {
        "name": "Dudhsagar Waterfalls",
        "desc": "Four-tiered white milky waterfall standing 310 meters tall inside Bhagwan Mahavir Sanctuary."
      },
      {
        "name": "Fort Aguada & Lighthouse",
        "desc": "17th-century Portuguese lighthouse and fort overlooking the Arabian Sea."
      },
      {
        "name": "Fontainhas Latin Quarter",
        "desc": "Heritage Portuguese colonial neighborhood with vibrant pastel houses."
      },
      {
        "name": "Dudhsagar Waterfalls",
        "desc": "Four-tiered white cascade waterfall in Bhagwan Mahaveer Sanctuary."
      }
    ],
    "hiddenGems": [
      ...
      "Butterfly Beach Secluded Cove - Serene cove accessible by boat."
    ],
    "safetyTips": [
  ...
  },
  {
    ...
    "foodSpecialties": [
      {
        "name": "Himachali Dham",
        "desc": "Festive vegetarian meal serving Rajma Madra, Sepu Badi, and Meetha Chawal."
      },
      {
        "name": "Siddu",
        "desc": "Steamed wheat flour dough stuffed with spiced poppy seed paste and dipped in hot ghee."
      },
      {
        "name": "Trout Fish Fry",
        "desc": "Fresh river trout marinated in local Himalayan herbs and shallow fried."
      },
      {
        "name": "Mittha",
        "desc": "Sweet rice dessert garnished with dry fruits and saffron."
      },
      {
        "name": "Babru",
        "desc": "Deep-fried stuffed flatbread served with black chickpea curry."
      },
      {
        "name": "Chha Gosht",
        "desc": "Slow-cooked lamb cooked in yogurt and gram flour gravy with cardamom."
      }
    ],
    ...
    "travelDestinationsInCity": [
      {
        "name": "Solang Valley",
        "desc": "Adventure sports hub for paragliding, skiing, zorbing, and quad biking."
      },
      {
        "name": "Rohtang Pass (13,058 ft)",
        "desc": "High mountain pass offering year-round snow landscapes."
      },
      {
        "name": "Hadimba Temple",
        "desc": "16th-century wooden pagoda temple surrounded by cedar forest."
      },
      {
        "name": "Atal Tunnel (Lahaul Gateway)",
        "desc": "9.02 km world longest highway tunnel above 10,000 feet."
      },
      {
        "name": "Solang Valley Adventure Arena",
        "desc": "Hub for paragliding, zorbing, and winter skiing."
      },
      {
        "name": "Jogini Waterfall Trek",
        "desc": "Picturesque waterfall trail originating from Vashisht hot springs."
      }
    ],
    "hiddenGems": [
      ...
      "Gulaba Alpine Meadows - Peaceful high-altitude meadow near Rohtang Pass."
    ],
    "safetyTips": [
  ...
  },
  {
    ...
    "foodSpecialties": [
      {
        ...
        "desc": "Hard baked wheat balls served with 5-lentil dal and sweet wheat churma."
      },
      {
        "name": "Laal Maas",
        "desc": "Fiery Rajput mutton curry cooked with garlic and Mathania red chillies."
      },
      {
        "name": "Ghevar",
        "desc": "Disc-shaped honeycomb sweet cake soaked in syrup and rabri."
      },
      {
        "name": "Pyaaz Kachori",
        "desc": "Crispy fried pastry stuffed with spiced onion filling."
      },
      {
        "name": "Mawa Kachori",
        "desc": "Sweet fried pastry stuffed with milk solids and soaked in cardamom sugar syrup."
      },
      {
        "name": "Ker Sangri",
        "desc": "Traditional desert vegetable dish cooked with dry berries and local spices."
      }
    ],
    ...
    "travelDestinationsInCity": [
      ...
      {
        "name": "Hawa Mahal",
        "desc": "Palace of Winds with 953 honeycomb windows."
      },
      {
        "name": "City Palace Jaipur",
        "desc": "Royal residence with Chandra Mahal museum."
      },
      {
        "name": "Jantar Mantar",
        "desc": "UNESCO astronomical observatory with world largest stone sundial."
      },
      {
        "name": "Nahargarh Fort Sunset Viewpoint",
        "desc": "Majestic hilltop fort with panoramic vistas over Pink City."
      },
      {
        "name": "Albert Hall Museum",
        "desc": "Indo-Saracenic museum housing royal artifacts and art."
      }
    ],
    "hiddenGems": [
      ...
      "Anokhi Hand Printing Museum - Heritage block printing gallery."
    ],
    "safetyTips": [
    ...
    "activities": [
      {
        "name": "Hot Air Balloon Ride over Amer Fort",
        "duration": "2 hours",
        "cost": 12000
      }
    ],
  ...
  },
  {
    ...
    "foodSpecialties": [
      {
        ...
        "desc": "Lacy rice pancakes served with aromatic coconut vegetable stew."
      },
      {
        "name": "Malabar Parotta & Mushroom Roast",
        "desc": "Flaky layered bread served with spicy roasted gravy."
      },
      {
        "name": "Ela Ada",
        "desc": "Steamed rice parcel stuffed with jaggery and grated coconut inside banana leaf."
      },
      {
        "name": "Puttu and Kadala Curry",
        "desc": "Steamed rice powder cylinders served with black chickpea curry."
      },
      {
        "name": "Banana Fritters (Pazham Pori)",
        "desc": "Crispy sweet ripe banana slices dipped in batter and fried."
      },
      {
        "name": "High Range Black Tea",
        "desc": "Freshly brewed aromatic tea leaves processed directly in local gardens."
      }
    ],
    ...
    "travelDestinationsInCity": [
      {
        ...
        "desc": "Sanctuary for rare Nilgiri Tahr goats and Anamudi Peak."
      },
      {
        "name": "Tata Tea Museum",
        "desc": "Historic tea processing museum showcasing heritage machinery."
      },
      {
        "name": "Mattupetty Dam & Lake",
        "desc": "Scenic lake offering speed boating and elephant sightings."
      },
      {
        "name": "Top Station Viewpoint",
        "desc": "Scenic panoramic valley view of neighboring Tamil Nadu."
      },
      {
        "name": "Eravikulam National Park",
        "desc": "Sanctuary of endangered Nilgiri Tahr mountain goats."
      },
      {
        "name": "Mattupetty Dam & Lake",
        "desc": "Scenic reservoir with speedboating and tea estate views."
      }
    ],
    "hiddenGems": [
      ...
      "Kolukkumalai Tea Estate - World's highest tea plantation peak."
    ],
    "safetyTips": [
    ...
    "activities": [
      {
        "name": "Tea Estate Guided Walking Tour",
        "duration": "2 hours",
        "cost": 500
      }
    ],
  ...
  },
  {
    ...
    "foodSpecialties": [
      {
        "name": "Mewari Royal Thali",
        "desc": "Royal meal serving Gatte ki Sabzi, Ker Sangri, and Bajra Roti."
      },
      {
        "name": "Kachori with Kadhi",
        "desc": "Crispy fried lentil pastry served with tasty spicy yogurt gravy."
      },
      {
        "name": "Safed Maas",
        "desc": "Rich chicken cooked in cashew, almond, coconut, and yogurt white gravy."
      },
      {
        "name": "Dil Jani",
        "desc": "Traditional orange and dry fruit sweet dessert served cold."
      },
      {
        "name": "Mirchi Vada",
        "desc": "Fried spicy green peppers stuffed with potato masala."
      },
      {
        "name": "Hari Mirch Ka Maas",
        "desc": "Spicy Mewari lamb dish cooked with fresh crushed green chillies."
      }
    ],
    ...
    "travelDestinationsInCity": [
      {
        ...
        "desc": "Vast palace complex overlooking Lake Pichola."
      },
      {
        "name": "Lake Pichola",
        "desc": "Romantic lake with boat rides to Jag Mandir."
      },
      {
        "name": "Jagdish Temple",
        "desc": "Stunning Indo-Aryan temple built in 1651."
      },
      {
        "name": "Fateh Sagar Lake",
        "desc": "Scenic artificial lake popular for boating."
      },
      {
        "name": "Shikara Boat Ride on Dal Lake",
        "desc": "Iconic wooden boat cruise through floating vegetable markets."
      },
      {
        "name": "Gulmarq Gondola Cable Car",
        "desc": "World's second-highest cable car offering panoramic snow views."
      }
    ],
    "hiddenGems": [
      ...
      "Dachigam National Park - Forest sanctuary protecting Hangul Kashmiri stag."
    ],
    "safetyTips": [
  ...
  },
  {
    ...
    "foodSpecialties": [
      {
        ...
        "desc": "Hand-pounded mutton meatballs cooked in red saffron gravy."
      },
      {
        "name": "Kahwa Tea",
        "desc": "Green tea brewed with saffron, almonds, and cardamom."
      },
      {
        "name": "Tabak Maaz",
        "desc": "Crispy fried mutton ribs cooked in spices and clarified butter."
      },
      {
        "name": "Gushtaba",
        "desc": "Spiced minced lamb balls cooked in rich yogurt gravy."
      },
      {
        "name": "Nadru Yakhni",
        "desc": "Lotus stems cooked in aromatic yogurt and mint sauce."
      },
      {
        "name": "Sheermal & Kashmiri Kulcha",
        "desc": "Traditional saffron flatbread and crispy butter biscuits."
      }
    ],
    ...
    "travelDestinationsInCity": [
      {
        "name": "Dal Lake",
        "desc": "Famous lake with floating houseboats & Shikaras."
      },
      {
        "name": "Shalimar Bagh",
        "desc": "Mughal terraced garden built by Jahangir."
      },
      {
        "name": "Nishat Bagh",
        "desc": "Garden of Gladness offering step fountains."
      },
      {
        "name": "Hazratbal Shrine",
        "desc": "Historic white marble Islamic shrine beside lake."
      },
      {
        "name": "Srinagar & Kashmir Local Heritage Site 5",
        "desc": "Historic landmark and popular tourist spot in Srinagar & Kashmir."
      },
      {
        "name": "Srinagar & Kashmir Local Heritage Site 6",
        "desc": "Historic landmark and popular tourist spot in Srinagar & Kashmir."
      }
    ],
    "hiddenGems": [
      ...
      "Srinagar & Kashmir Secret Scenic Viewpoint - Offbeat tranquil spot away from crowds."
    ],
    "safetyTips": [
  ...
  },
  {
    ...
    "foodSpecialties": [
      {
        "name": "Agra Petha",
        "desc": "Ash gourd sweet infused with saffron and nuts."
      },
      {
        "name": "Mughlai Biryani",
        "desc": "Aromatic basmati rice cooked with whole spices."
      },
      {
        "name": "Bedai Sabzi",
        "desc": "Crispy fried lentil flatbread served with spicy potato curry."
      },
      {
        "name": "Agra Jalebi",
        "desc": "Golden loops of sugar-soaked fried batter."
      },
      {
        "name": "Mughlai Chicken",
        "desc": "Rich chicken curry cooked in almond and onion paste."
      },
      {
        "name": "Seekh Kababs",
        "desc": "Spiced minced lamb skewered and charcoal grilled."
      }
    ],
    ...
    "travelDestinationsInCity": [
      {
        "name": "Taj Mahal",
        "desc": "UNESCO Wonder of the World in white marble."
      },
      {
        "name": "Agra Fort",
        "desc": "Red sandstone Mughal imperial fortress."
      },
      {
        "name": "Itmad-ud-Daulah",
        "desc": "Jewel box tomb known as Baby Taj."
      },
      {
        "name": "Fatehpur Sikri",
        "desc": "Akbar's red sandstone royal capital city."
      },
      {
        "name": "Mehtab Bagh Moonlight Garden",
        "desc": "Mughal garden offering reflective Taj Mahal views across Yamuna."
      },
      {
        "name": "Akbar Tomb at Sikandra",
        "desc": "Red sandstone and marble mausoleum of Emperor Akbar."
      }
    ],
    "hiddenGems": [
      ...
      "Chini Ka Rauza Persian Tomb - Glazed tile Persian architecture monument."
    ],
    "safetyTips": [
    ...
    "activities": [
      {
        "name": "Sunrise Taj Mahal Guided Tour",
        "duration": "3 hours",
        "cost": 1100
      }
    ],
  ...
  },
  {
    ...
    "foodSpecialties": [
      {
        ...
        "desc": "Iconic Delhi dish invented at Moti Mahal in 1947."
      },
      {
        "name": "Chandni Chowk Paranthas",
        "desc": "Stuffed fried flatbreads served with tasty chutneys."
      },
      {
        "name": "Chole Bhature",
        "desc": "Spiced chickpea curry paired with deep-fried puffy bread."
      },
      {
        "name": "Dahi Bhalla Chat",
        "desc": "Lentil fritters soaked in sweet yogurt and spicy chutneys."
      },
      {
        "name": "Nihari Beef/Mutton",
        "desc": "Slow-cooked spiced Mughal stew served with warm Tandoori Roti."
      },
      {
        "name": "Karim's Mutton Seekh Kababs",
        "desc": "Famous street food kababs from Nizamuddin markets."
      }
    ],
    ...
    "travelDestinationsInCity": [
      {
        "name": "Red Fort",
        "desc": "Mughal sandstone fortress."
      },
      {
        "name": "Qutub Minar",
        "desc": "World's tallest brick minaret."
      },
      {
        "name": "Humayun's Tomb",
        "desc": "Stunning red sandstone precursor to Taj Mahal."
      },
      {
        "name": "India Gate",
        "desc": "War memorial arch at Rajpath."
      },
      {
        "name": "Akshardham Temple Complex",
        "desc": "Grand pink sandstone cultural temple with water show."
      },
      {
        "name": "Lotus Temple Sanctuary",
        "desc": "Baháʼí House of Worship shaped like a white lotus flower."
      }
    ],
    "hiddenGems": [
      ...
      "Agrasen Ki Baoli Stepwell - 14th-century historic stone stepwell."
    ],
    "safetyTips": [
    ...
    "activities": [
      {
        "name": "Old Delhi Chandni Chowk Rickshaw & Street Food Tour",
        "duration": "3 hours",
        "cost": 800
      }
    ],
  ...
  },
  {
    ...
    "foodSpecialties": [
      {
        "name": "Chana Madra",
        "desc": "Tangy Himachali black chickpea curry cooked in yogurt and ghee."
      },
      {
        "name": "Siddu with Ghee",
        "desc": "Steamed wheat dough filled with walnuts and poppy seeds."
      },
      {
        "name": "Mash Dal",
        "desc": "Slow-cooked split black lentils flavored with ginger and garlic."
      },
      {
        "name": "Kullu Trout Fish fry",
        "desc": "Local river fish fried in mustard oil and fresh spices."
      },
      {
        "name": "Meetha Rice",
        "desc": "Sweetened saffron rice topped with dry fruits."
      },
      {
        "name": "Sepu Badi Sabzi",
        "desc": "Spinach and split black lentil dumplings cooked in yogurt gravy."
      }
    ],
    ...
    "travelDestinationsInCity": [
      {
        ...
        "desc": "Promenade with Neo-Gothic church."
      },
      {
        "name": "Mall Road",
        "desc": "Pedestrian shopping avenue."
      },
      {
        "name": "Viceregal Lodge",
        "desc": "Neo-Elizabethan colonial palace of Viceroy."
      },
      {
        "name": "Jakhu Temple (8,000 ft)",
        "desc": "Hilltop Hanuman temple with giant statue."
      },
      {
        "name": "Shalimar Bagh Mughal Garden",
        "desc": "Largest Mughal garden built by Emperor Jahangir."
      },
      {
        "name": "Pari Mahal Palace",
        "desc": "Seven-terraced Mughal garden overlooking Dal Lake."
      }
    ],
    "hiddenGems": [
      ...
      "Nigeen Lake Quiet Shikara Walk - Peaceful serene lake."
    ],
    "safetyTips": [
    ...
    "activities": [
      {
        "name": "Kalka-Shimla Toy Train Scenic Ride",
        "duration": "3 hours",
        "cost": 500
      }
    ],
  ...
  },
  {
    ...
    "foodSpecialties": [
      {
        ...
        "desc": "Flaky paratha rolled with spiced grilled meat kababs."
      },
      {
        "name": "Rosogolla & Mishti Doi",
        "desc": "Spongy sweet syrup balls & sweet baked yogurt."
      },
      {
        "name": "Machher Jhol",
        "desc": "Traditional Bengali fish curry cooked with mustard oil and spices."
      },
      {
        "name": "Kolkata Biryani",
        "desc": "Fragrant basmati rice cooked with saffron, meat, and signature spiced potato."
      },
      {
        "name": "Luchi & Alur Dom",
        "desc": "Puffy deep-fried flatbread paired with spiced potato curry."
      },
      {
        "name": "Sondesh Dessert",
        "desc": "Traditional sweet dessert made of sweetened fresh cottage cheese."
      }
    ],
    ...
    "travelDestinationsInCity": [
      {
        ...
        "desc": "White marble palace dedicated to Queen Victoria."
      },
      {
        "name": "Howrah Bridge",
        "desc": "Iconic cantilever bridge over Hooghly River."
      },
      {
        "name": "Dakshineswar Kali Temple",
        "desc": "19th-century temple on banks of Hooghly."
      },
      {
        "name": "Indian Museum Kolkata",
        "desc": "Oldest museum in India established in 1814."
      },
      {
        "name": "Kolkata Local Heritage Site 5",
        "desc": "Historic landmark and popular tourist spot in Kolkata."
      },
      {
        "name": "Kolkata Local Heritage Site 6",
        "desc": "Historic landmark and popular tourist spot in Kolkata."
      }
    ],
    "hiddenGems": [
      ...
      "Kolkata Secret Scenic Viewpoint - Offbeat tranquil spot away from crowds."
    ],
    "safetyTips": [
    ...
    "activities": [
      {
        "name": "Heritage Tram Ride & College Street Book Walk",
        "duration": "3 hours",
        "cost": 300
      }
    ],
  ...
  },
  {
    ...
    "foodSpecialties": [
      {
        "name": "Mysore Pak",
        "desc": "Melt-in-mouth golden sugar and ghee chickpea flour sweet."
      },
      {
        "name": "Mysore Masala Dosa",
        "desc": "Crispy rice crepe lined with red garlic spicy chutney."
      },
      {
        "name": "Obbattu",
        "desc": "Traditional sweet flatbread stuffed with jaggery and coconut."
      },
      {
        "name": "Mysore Bonda",
        "desc": "Deep-fried fluffy lentil flour fritters served with coconut chutney."
      },
      {
        "name": "Ragi Mudde & Saaru",
        "desc": "Nutritious finger millet balls served with spicy vegetable soup."
      },
      {
        "name": "Mysore Filter Coffee",
        "desc": "Traditional frothy coffee brewed with roasted chicory beans."
      }
    ],
    ...
    "travelDestinationsInCity": [
      {
        "name": "Mysore Palace",
        "desc": "Royal residence illuminated by 100,000 bulbs."
      },
      {
        "name": "Chamundi Hill",
        "desc": "Temple hill with giant Nandi monolith."
      },
      {
        "name": "Brindavan Gardens",
        "desc": "Terraced musical fountain gardens beside dam."
      },
      {
        "name": "Somnathpur Temple",
        "desc": "Stunning 13th-century Hoysala stone temple."
      },
      {
        "name": "Christ Church Mall Road",
        "desc": "Second oldest church in North India located on the Ridge."
      },
      {
        "name": "Kufri Snow Adventure Park",
        "desc": "High-altitude winter sports and yak riding destination."
      }
    ],
    "hiddenGems": [
      ...
      "Annandale Heritage Ground - Lush green plateau with army museum."
    ],
    "safetyTips": [
    ...
    "activities": [
      {
        "name": "Mysore Royal Palace Night Illumination Tour",
        "duration": "2 hours",
        "cost": 200
      }
    ],
  ...
  },
  {
    ...
    "foodSpecialties": [
      {
        ...
        "desc": "Cooling dessert milk drink with almond gum & basundi."
      },
      {
        "name": "Kari Dosa",
        "desc": "Thick local rice pancake topped with spiced minced lamb and eggs."
      },
      {
        "name": "Kothu Parotta",
        "desc": "Shredded flaky flatbread stir-fried with eggs, meat, and salna gravy."
      },
      {
        "name": "Bun Parotta",
        "desc": "Fluffy sponge-like bun layered flatbread fried with ghee."
      },
      {
        "name": "Paruthi Paal",
        "desc": "Traditional warm sweet drink made of cottonseed milk and ginger."
      },
      {
        "name": "Idiyappam & Salna",
        "desc": "Steamed rice noodles served with spicy vegetable curry."
      }
    ],
    ...
    "travelDestinationsInCity": [
      {
        ...
        "desc": "14-towered Dravidian temple with detailed sculptures."
      },
      {
        "name": "Thirumalai Nayakkar Palace",
        "desc": "17th-century palace with massive white pillars."
      },
      {
        "name": "Alagar Kovil Temple",
        "desc": "Hillside Vishnu temple with natural springs."
      },
      {
        "name": "Vandiyur Mariamman Teppakulam",
        "desc": "Huge temple tank popular for float festivals."
      },
      {
        "name": "Madurai Local Heritage Site 5",
        "desc": "Historic landmark and popular tourist spot in Madurai."
      },
      {
        "name": "Madurai Local Heritage Site 6",
        "desc": "Historic landmark and popular tourist spot in Madurai."
      }
    ],
    "hiddenGems": [
      ...
      "Madurai Secret Scenic Viewpoint - Offbeat tranquil spot away from crowds."
    ],
    "safetyTips": [
    ...
    "activities": [
      {
        "name": "Meenakshi Temple Evening Night Ceremony Walk",
        "duration": "2 hours",
        "cost": 0
      }
    ],
  ...
  },
  {
    ...
    "foodSpecialties": [
      {
        ...
        "desc": "Pearl spot fish marinated and shallow fried inside banana leaves."
      },
      {
        "name": "Kappa and Meen Curry",
        "desc": "Boiled mashed tapioca served with spicy red fish curry."
      },
      {
        "name": "Kerala Puttu & Kadala",
        "desc": "Steamed rice cylinders served with spiced chickpea curry."
      },
      {
        "name": "Duck Mappas",
        "desc": "Tender duck pieces slow-cooked in creamy coconut milk gravy."
      },
      {
        "name": "Payasam",
        "desc": "Traditional sweet milk pudding made with rice and coconut milk."
      },
      {
        "name": "Toddy Shop Seafood Sabzi",
        "desc": "Spicy clam stir-fry paired with sweet coconut palm toddy."
      }
    ],
    ...
    "travelDestinationsInCity": [
      {
        ...
        "desc": "Network of palm-fringed canals and lagoons."
      },
      {
        "name": "Marari Beach",
        "desc": "Quiet coconut-palm beach for relaxation."
      },
      {
        "name": "Alappuzha Lighthouse",
        "desc": "Historic 1862 lighthouse overlooking the sea."
      },
      {
        "name": "Punnamada Lake",
        "desc": "Scenic venue of the Nehru Trophy Snake Boat Race."
      },
      {
        "name": "Auroville Globe Matrimandir",
        "desc": "Golden spherical sanctuary for silent meditation."
      },
      {
        "name": "Paradise Beach Sandbar Island",
        "desc": "Secluded golden sand beach accessible via boat ferry."
      }
    ],
    "hiddenGems": [
      ...
      "Arikamedu Ancient Roman Trade Ruins - 2,000-year-old port site."
    ],
    "safetyTips": [
    ...
    "activities": [
      {
        "name": "Overnight Private Kettuvallam Houseboat Cruise",
        "duration": "Overnight",
        "cost": 6000
      }
    ],
  ...
  },
  {
    ...
    "foodSpecialties": [
      {
        "name": "French Croissant & Quiche",
        "desc": "Authentic French bakeries serving fresh quiche and pain au chocolat."
      },
      {
        "name": "Mutton Rolls & Samosas",
        "desc": "Local spicy tea-time snacks served with mint chutney."
      },
      {
        "name": "Pondy Crab Masala",
        "desc": "Spicy Tamil style crab stir-fry cooked in pepper gravy."
      },
      {
        "name": "Crepe Suzette",
        "desc": "Thin French sweet pancakes served with orange syrup."
      },
      {
        "name": "Ratatouille vegetable dish",
        "desc": "Classic French stewed vegetable dish."
      },
      {
        "name": "Filter Kaapi",
        "desc": "Foamy South Indian coffee served in brass cups."
      }
    ],
    ...
    "travelDestinationsInCity": [
      {
        ...
        "desc": "Seaside walking boulevard along French Quarter."
      },
      {
        "name": "French Quarter",
        "desc": "Pastel yellow colonial homes with bougainvillea."
      },
      {
        "name": "Auroville Matrimandir",
        "desc": "Golden spherical meditation sanctuary."
      },
      {
        "name": "Sri Aurobindo Ashram",
        "desc": "Spiritual ashram founded in 1926."
      },
      {
        "name": "Marari Beach Quiet Cove",
        "desc": "Peaceful fishing village beach lined with coconut palms."
      },
      {
        "name": "Vembanad Lake Houseboat Cruise",
        "desc": "Largest lake in Kerala with overnight backwater cruises."
      }
    ],
    "hiddenGems": [
      ...
      "St. Andrew's Basilica Arthunkal - Historic 16th-century Portuguese church."
    ],
    "safetyTips": [
    ...
    "activities": [
      {
        "name": "French Town Cycle Heritage Tour",
        "duration": "2 hours",
        "cost": 350
      }
    ],
  ...
  },
  {
    ...
    "foodSpecialties": [
      {
        ...
        "desc": "Iconic street food spicy potato patty in soft bread bun."
      },
      {
        "name": "Bhel Puri Chat",
        "desc": "Crispy puffed rice mixed with tangy tamarind chutney and veggies."
      },
      {
        "name": "Bombay Sandwich",
        "desc": "Triple layer toast sandwich filled with potatoes, beetroot, and mint chutney."
      },
      {
        "name": "Keema Ghotala",
        "desc": "Spiced minced mutton cooked with scrambled eggs."
      },
      {
        "name": "Misal Pav",
        "desc": "Spicy moth bean curry topped with farsan and served with bread."
      },
      {
        "name": "Falooda Sweet",
        "desc": "Cold dessert drink with vermicelli, rose syrup, and ice cream."
      }
    ],
    ...
    "travelDestinationsInCity": [
      {
        ...
        "desc": "1924 waterfront arch monument."
      },
      {
        "name": "Marine Drive",
        "desc": "Queen's Necklace seaside boulevard."
      },
      {
        "name": "Chhatrapati Shivaji Maharaj Terminus",
        "desc": "UNESCO Victorian Gothic railway station."
      },
      {
        "name": "Haji Ali Dargah",
        "desc": "15th-century mosque located on an islet."
      },
      {
        "name": "Marine Drive Queen's Necklace",
        "desc": "3.6 km long C-shaped boulevard along the Arabian Sea."
      },
      {
        "name": "Haji Ali Dargah Islet",
        "desc": "15th-century mosque located on an islet off the Worli coast."
      }
    ],
    "hiddenGems": [
      ...
      "Banganga Sacred Water Tank - Ancient 12th-century water tank walk."
    ],
    "safetyTips": [
    ...
    "activities": [
      {
        "name": "Elephanta Caves Boat Tour from Gateway of India",
        "duration": "4 hours",
        "cost": 700
      }
    ],
  ...
  },
  {
    ...
    "foodSpecialties": [
      {
        ...
        "desc": "Tangy fish curry cooked with elephant apple or lemon."
      },
      {
        "name": "Aloo Pitika",
        "desc": "Mashed potatoes flavored with raw onions, green chillies, and mustard oil."
      },
      {
        "name": "Duck Curry with Ash Gourd",
        "desc": "Tender duck meat cooked with native spices and ash gourd."
      },
      {
        "name": "Pitha Sweets",
        "desc": "Steamed rice cakes filled with sweet sesame or jaggery."
      },
      {
        "name": "Khar vegetable dish",
        "desc": "Traditional starter prepared with sun-dried banana ashes."
      },
      {
        "name": "Assam Milk Tea",
        "desc": "Rich brewed tea made from premium CTC black tea leaves."
      }
    ],
    ...
    "travelDestinationsInCity": [
      {
        "name": "One-Horned Rhino Safari Zone",
        "desc": "Tall elephant grass wildlife sanctuary."
      },
      {
        "name": "Kaziranga Orchid Park",
        "desc": "Botanical garden showcasing native Assam orchids."
      },
      {
        "name": "Brahmaputra River Bank",
        "desc": "Scenic delta plains home to dolphins."
      },
      {
        "name": "Hathikuli Tea Estate",
        "desc": "Organic tea estate offering fresh tasting tours."
      },
      {
        "name": "Orchid & Biodiversity Park",
        "desc": "Conservation park housing 500+ indigenous orchid species."
      },
      {
        "name": "Brahmaputra River Boat Safari",
        "desc": "Sunset cruise to spot river dolphins and migratory birds."
      }
    ],
    "hiddenGems": [
    ...
    "activities": [
      {
        "name": "Kaziranga Morning Elephant & Jeep Safari",
        "duration": "3.5 hours",
        "cost": 2200
      }
    ],
  ...
  },
  {
    ...
    "foodSpecialties": [
      {
        "name": "Coastal Fish Thali",
        "desc": "Fresh Arabian sea fish fried with spicy Byadgi chillies."
      },
      {
        "name": "Gokarna Prawn Masala",
        "desc": "Spicy coastal curry served with hot boiled rice."
      },
      {
        "name": "Neer Dosa & Chutney",
        "desc": "Lacy thin rice crepes served with coconut chutney."
      },
      {
        "name": "Clam Fry (Tisriya)",
        "desc": "Stir-fried shellfish cooked in fresh coconut and spices."
      },
      {
        "name": "Banana Buns",
        "desc": "Sweet fried banana-wheat flour buns popular for breakfast."
      },
      {
        "name": "Kokum Sharbat",
        "desc": "Refreshing tangy pink drink made of forest kokum fruit extract."
      }
    ],
    ...
    "travelDestinationsInCity": [
      {
        "name": "Om Beach",
        "desc": "Natural sandy beach shaped like holy Om symbol."
      },
      {
        "name": "Kudle Beach",
        "desc": "Wide sandy beach lined with beach shacks."
      },
      {
        "name": "Mahabaleshwar Temple",
        "desc": "Ancient Shiva temple holding the sacred Atmalinga."
      },
      {
        "name": "Paradise Beach",
        "desc": "Quiet secluded cove beach accessible by boat."
      },
      {
        "name": "Half Moon Beach Cove",
        "desc": "Secluded crescent beach accessible via cliff hiking trails."
      },
      {
        "name": "Paradise Beach Sandbar",
        "desc": "Pristine white sand beach surrounded by rocky hills."
      }
    ],
    "hiddenGems": [
      ...
      "Yana Rocks Limestone Caves - Twin black karst rock monoliths in jungle."
    ],
    "safetyTips": [
    ...
    "activities": [
      {
        "name": "Gokarna 5-Beach Cliff Trekking Trail",
        "duration": "4 hours",
        "cost": 500
      }
    ],
  ...
  },
  {
    ...
    "foodSpecialties": [
      {
        ...
        "desc": "Spicy Tamil coastal fish curry cooked with tamarind and fresh coconut paste."
      },
      {
        "name": "Nanjil Fish Fry",
        "desc": "Spicy fish fry prepared with local herbs and fried in coconut oil."
      },
      {
        "name": "Banana Chips (Nendran)",
        "desc": "Crispy thick chips made of local ripe bananas."
      },
      {
        "name": "Kothu Parotta",
        "desc": "Shredded flatbread stir-fried with eggs, vegetables, and chicken gravy."
      },
      {
        "name": "Elaneer Payasam",
        "desc": "Creamy sweet pudding prepared with tender coconut pulp."
      },
      {
        "name": "Ulunthan Kanji",
        "desc": "Traditional healthy breakfast porridge made of black gram and rice."
      }
    ],
    ...
    "travelDestinationsInCity": [
      {
        ...
        "desc": "Rock island monument in the middle of three oceans."
      },
      {
        "name": "Thiruvalluvar Statue",
        "desc": "133-foot stone statue dedicated to the Tamil poet."
      },
      {
        "name": "Kanyakumari Temple",
        "desc": "Ancient coastal temple dedicated to Goddess Kanya Kumari."
      },
      {
        "name": "Sunset Point",
        "desc": "Waterfront promenade offering simultaneous views of sunrise & sunset."
      },
      {
        "name": "Thiruvalluvar Statue Rock Island",
        "desc": "133-foot stone statue dedicated to the Tamil poet."
      },
      {
        "name": "Padmanabhapuram Teakwood Palace",
        "desc": "16th-century wooden palace of Travancore kings."
      }
    ],
    "hiddenGems": [
      ...
      "Vattakottai Seaside Brick Fort - 18th-century coastal defense fort."
    ],
    "safetyTips": [
    ...
    "activities": [
      {
        "name": "Ferry Ride to Vivekananda Rock Memorial",
        "duration": "2 hours",
        "cost": 150
      }
    ],
  ...
  },
  {
    ...
    "foodSpecialties": [
      {
        "name": "Spiti Butter Tea",
        "desc": "Salted yak butter tea brewed with local tea leaves."
      },
      {
        "name": "Momo Dumplings",
        "desc": "Steamed barley flour dumplings stuffed with vegetables."
      },
      {
        "name": "Thukpa Noodle Soup",
        "desc": "Warm vegetable noodle broth spiced with Himalayan herbs."
      },
      {
        "name": "Tingmo Steamed Bread",
        "desc": "Fluffy steamed Tibetan bread rolls served with hot stews."
      },
      {
        "name": "Thenthuk Soup",
        "desc": "Hand-pulled noodle soup prepared with mixed mountain vegetables."
      },
      {
        "name": "Chhurpi Cheese",
        "desc": "Hard dried cheese made from local yak milk."
      }
    ],
    ...
    "travelDestinationsInCity": [
      {
        "name": "Key Monastery",
        "desc": "1,000-year-old fortress monastery on a cliff."
      },
      {
        "name": "Chandratal Lake",
        "desc": "Crescent-shaped high-altitude glacial lake."
      },
      {
        "name": "Hikkim Post Office (14,567 ft)",
        "desc": "Highest working post office in the world."
      },
      {
        "name": "Tabo Monastery",
        "desc": "10th-century historic Buddhist monastery complex."
      },
      {
        "name": "Chandratal Moon Lake",
        "desc": "High-altitude turquoise lake reflecting Himalayan peaks."
      },
      {
        "name": "Hikkim Highest Post Office",
        "desc": "World's highest post office at 14,567 feet altitude."
      }
    ],
    "hiddenGems": [
      ...
      "Langza Fossil Village - Ancient Jurassic marine fossil beds."
    ],
    "safetyTips": [
    ...
    "activities": [
      {
        "name": "Chandratal Lake High-Altitude Camping",
        "duration": "Overnight",
        "cost": 2500
      }
    ],
  ...
  },
  {
    ...
    "foodSpecialties": [
      {
        "name": "Skyu Stew",
        "desc": "Traditional Ladakhi pasta & vegetable stew."
      },
      {
        "name": "Thukpa Soup",
        "desc": "Noodle soup prepared with vegetables and spices."
      },
      {
        "name": "Khambir Bread",
        "desc": "Traditional thick crust sourdough flatbread served with tea."
      },
      {
        "name": "Chhurpi Cheese Soup",
        "desc": "Warm soup flavored with local dried yak cheese."
      },
      {
        "name": "Gur Gur Cha",
        "desc": "Butter tea brewed with yak butter, salt, and tea leaves."
      },
      {
        "name": "Momo Dumplings",
        "desc": "Steamed wheat dumplings filled with local ingredients."
      }
    ],
    ...
    "travelDestinationsInCity": [
      {
        ...
        "desc": "Endorheic salt lake changing colors from blue to emerald."
      },
      {
        "name": "Nubra Valley",
        "desc": "Cold desert sand dunes with double-humped camels."
      },
      {
        "name": "Thiksey Monastery",
        "desc": "Twelve-story Buddhist monastery complex."
      },
      {
        "name": "Khardung La Pass (17,582 ft)",
        "desc": "Highest motorable mountain pass in the region."
      },
      {
        "name": "Leh-Ladakh Local Heritage Site 5",
        "desc": "Historic landmark and popular tourist spot in Leh-Ladakh."
      },
      {
        "name": "Leh-Ladakh Local Heritage Site 6",
        "desc": "Historic landmark and popular tourist spot in Leh-Ladakh."
      }
    ],
    "hiddenGems": [
      ...
      "Leh-Ladakh Secret Scenic Viewpoint - Offbeat tranquil spot away from crowds."
    ],
    "safetyTips": [
    ...
    "activities": [
      {
        "name": "Nubra Valley Bactrian Camel Safari",
        "duration": "2 hours",
        "cost": 1000
      }
    ],
